...
import com.aya.news.ayanews.common.FractionalTouchDelegate;
import com.aya.news.ayanews.common.StringUtils;
import com.aya.news.ayanews.common.ToastUtils;
import com.aya.news.ayanews.model.CommonGestures;
...
public class MediaController extends FrameLayout {
	...
	private void toggleVideoMode(boolean larger, boolean recycle) {
		...
		case VideoView.VIDEO_LAYOUT_ZOOM:
			...
			mScreenToggle.setImageResource(R.mipmap.mediacontroller_sreen_size_crop);
			break;
		}
	...
	private OnClickListener mDanmakuSendListener = new OnClickListener() {
		@Override
		public void onClick(View v) {
			ToastUtils.show(getContext(),"mDanmakuSendListener");
		}
	};
